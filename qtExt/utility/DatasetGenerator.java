...
public class DatasetGenerator {
    // Logger.
    private static final Logger logger = Logger.getLogger(DatasetGenerator.class.getName());

    // Categorie sintetiche per attributi discreti.
    ...
    public static void generateDataset(String filename, int numTuples, int numAttributes, long seed) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filename))) {
            ...
            logger.log(Level.SEVERE, () -> String.valueOf("Error generating dataset: " + e.getMessage()));
        }
    }
    ...
    public static void generateTestSuite() {
        logger.info(() -> String.valueOf("Generating synthetic test datasets...\n"));
