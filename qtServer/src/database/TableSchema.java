...
public class TableSchema {
    ...
    public TableSchema(DbAccess db, String tableName) throws SQLException {
        this.db = db;
        String safeTableName = DbAccess.requireSafeIdentifier(tableName, "Nome tabella");
        ...
        ResultSet res = meta.getColumns(null, null, safeTableName, null);
        ...
        while (res.next()) {
            ...
            // Salta colonne auto-increment (tipicamente 'id').
            if ("YES".equals(isAutoIncrement)) {
                continue;
            }

            if (mapSQL_JAVATypes.containsKey(typeName))
                tableSchema.add(new Column(columnName, mapSQL_JAVATypes.get(typeName)));
        }
        res.close();
    }
