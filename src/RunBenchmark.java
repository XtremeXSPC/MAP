...
public class RunBenchmark {
    ...
    public static void main(String[] args) {
        ...
        QTBenchmark.BenchmarkResult[] small =
                QTBenchmark.runComparison("../data/synthetic_small.csv", 0.4);
        ...
        QTBenchmark.BenchmarkResult[] medium =
                QTBenchmark.runComparison("../data/synthetic_medium.csv", 0.4);
        ...
        QTBenchmark.BenchmarkResult[] large =
                QTBenchmark.runComparison("../data/synthetic_large.csv", 0.4);
        ...
        System.out.printf("Piccolo (50)   | %10d ms | %11d ms | %6.2fx | %7.1f%%\n",
                small[0].executionTimeMs, small[1].executionTimeMs, speedupSmall,
                small[1].cacheHitRate * 100);
        System.out.printf("Medio (200)    | %10d ms | %11d ms | %6.2fx | %7.1f%%\n",
                medium[0].executionTimeMs, medium[1].executionTimeMs, speedupMedium,
                medium[1].cacheHitRate * 100);
        System.out.printf("Grande (1000)  | %10d ms | %11d ms | %6.2fx | %7.1f%%\n",
                large[0].executionTimeMs, large[1].executionTimeMs, speedupLarge,
                large[1].cacheHitRate * 100);

        fullReport.append("\nTABELLA RIEPILOGO\n");
        fullReport.append("-".repeat(80)).append("\n");
        fullReport.append(String.format("%-15s | %13s | %14s | %7s | %9s\n", "Dim. Dataset",
                "Tempo Base", "Tempo Ottim.", "Speedup", "Hit Rate"));
        fullReport.append("-".repeat(80)).append("\n");
        ...
        if (large[1].cacheHitRate >= 0.5) {
            System.out
                    .println("✓ Cache funzionante efficacemente (>50% hit rate su dataset grande)");
